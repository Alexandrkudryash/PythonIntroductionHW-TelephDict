...
def get_surname(sex):
    ...
    with open ('random_person\\surnames.txt',encoding="utf8") as sur:
        surnames = list(sur)
    if sex:
...
def get_name(sex):
    if sex == 1: 
        ...
        with open ('random_person\\male_names.txt',encoding="utf8") as f:
            names = list(f)         
    else:
        #with open ('dz_7\\random_person\\female_names.txt',encoding="utf8") as f:
        with open ('random_person\\female_names.txt',encoding="utf8") as f:
            names = list(f)    
...
def get_description():
    ...
    with open ('random_person\\descriptions.txt',encoding="utf8") as f:
            professions = list(f)    
